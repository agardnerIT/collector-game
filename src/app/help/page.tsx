...
function helpSections() {
  ...
  const easy = challenges.filter((c) => c.difficulty === "easy" && c.id !== "level-01").length;
  ...
  return [
    ...
    },
    {
      ...
      body: `Challenges are grouped into four tiers: **Starter** (1), **Easy** (${easy}), **Medium** (${medium}), and **Hard** (${hard}). Difficulty is determined by a rubric across four dimensions: number of concepts required, OTTL complexity, number of config sections, and number of steps in the solution.\n\n- **Starter:** Onboarding — delete a single attribute (always unlocked)\n- **Easy:** Single-action processors, basic metric receivers, simple OTTL\n- **Medium:** Multi-field configs, metric processing, exporter setup, conditional OTTL\n- **Hard:** Multi-step pipelines, domain-specific configs, advanced OTTL`,
    },
    {
      title: "Tier Unlocks",
      body: `Progression is tier-based. The Starter challenge is always unlocked. Complete the **Starter** to unlock Easy. Complete **all ${easy} Easy** challenges to unlock Medium. Complete **all ${medium} Medium** to unlock Hard.`,
    },
    {
      title: "Scoring",
